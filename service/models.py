...
class Service(models.Model):
    ...
    d_timeout = models.IntegerField("Частота обновления (дневной)", default=30, help_text="В минутах")
    w_timeout = models.IntegerField("Частота обновления (недельный)", default=10080, help_text="В минутах")
    b_timeout = models.IntegerField("Частота обновления недельный(больше)", default=10080, help_text="В минутах")
    bd_timeout = models.IntegerField("Частота обновления дневной (больше)", default=10080, help_text="В минутах")
    ...
    rsi_b = models.CharField("RSI недельный (больше)", max_length=130, default='25')
    rsi_bd = models.CharField("RSI дневной (больше)", max_length=130, default='25')
