...
for item in api_request.json():
    ...
    threading.Thread(target=parser, name="B parser", args=(item.get('rsi_b'), item.get('papers'),
                                                           item.get('b_timeout'), "bw")).start()

    threading.Thread(target=parser, name="Bd parser", args=(item.get('rsi_bd'), item.get('papers'),
                                                            item.get('bd_timeout'), "bd")).start()
